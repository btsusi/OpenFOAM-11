...
void Foam::solvers::laserCompressibleMultiphaseVoF::alphaSolve
(
...
)
{
    ...
    {
        const laserCompressibleVoFphase& alpha = phases[phasei];
        ...
        {
            laserCompressibleVoFphase& alpha2 = phases[phasej];
    ...
    forAll(phases, phasei)
    {
        laserCompressibleVoFphase& alpha = phases[phasei];
        ...
        forAll(phases, phasej)
        {
            const laserCompressibleVoFphase& alpha2 = phases[phasej];
...
void Foam::solvers::laserCompressibleMultiphaseVoF::alphaPredictor()
{
