...
#include "laserCompressibleVoFphase.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::laserCompressibleVoFphase::laserCompressibleVoFphase
(
    const word& name,
    const fvMesh& mesh,
...
Foam::autoPtr<Foam::VoFphase> Foam::laserCompressibleVoFphase::clone() const
{
    NotImplemented;
...
void Foam::laserCompressibleVoFphase::correct
(
